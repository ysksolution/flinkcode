 ...
 */
public class Dws_09_Times2 extends BaseAPPV1 {

    public static void main(String[] args) {
        new com.sjfood.sjfood.gmallrealtime.app.dws.Dws_09_DwsTradeSkuOrderWindow().init(
        ...
        return beanStreamWithoutDim
                .map(new RichMapFunction<TradeSkuOrderBean, TradeSkuOrderBean>() {
                    ...
                    public TradeSkuOrderBean map(TradeSkuOrderBean bean) throws Exception {
                        ...
                        //2.通过连接对象，获取一个预处理语句
                        //会存在sql注入：where id = '1' or '1' = '1'
                     /*   PreparedStatement ps = conn.prepareStatement("select * from dim_sku_info where id=?");
